...
import {
    Stat as ChakraStat, Text, StatLabel, StatNumber,
...
export const EstimatedMileageStat = ({ vehicle }) => vehicle.estimatedMileage && (
...
export const SinceStat = ({ oldestRecord }) => oldestRecord && (
    <Stat label="Since">
        {intlFormat(parseDateUTC(oldestRecord?.date), { month: 'short', year: 'numeric', day: 'numeric' })}
    </Stat>
);

export const DurationStat = ({ oldestRecord }) => oldestRecord && (
    <Stat label="Duration">
