...
export type EstimateReminderParams = Pick<
API.Reminder,
'date' | 'mileage' | 'reminderType'
>;

export const remindersAPIPath = (vehicleId: API.RecordID) =>
    `/api/vehicles/${vehicleId}/reminders`;
export const reminderAPIPath = (
    vehicleId: API.RecordID,
    reminderId: API.RecordID,
) => `/api/vehicles/${vehicleId}/reminders/${reminderId}`;
...
export function updateReminder(
    api: AxiosInstance,
    vehicleId: API.RecordID,
    params: MutateParams<ReminderParams>,
) {
...
export async function destroyReminder(
    api: AxiosInstance,
    vehicleId: API.RecordID,
    reminderId: API.RecordID,
) {
...
export async function estimateReminderDate(
    api: AxiosInstance,
    vehicleId: API.RecordID,
    reminder: EstimateReminderParams,
) {
    const { data } = await api.get(
        `/api/vehicles/${vehicleId}/reminders/estimate_date`,
        {
            params: {
                reminder,
            },
